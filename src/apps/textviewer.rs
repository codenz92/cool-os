...
const ABOUT: &[&str] = &[
    ...
    "",
    " == Current Platform ==",
    " Ring-3 ELF apps with per-process address spaces",
    ...
    " Browser compat/source routing/JS/DOM/forms/CSS",
    ...
    " Userspace threads, futex wait/wake, TLS, and pthread shims",
    ...
    " pkg          - verify/install/repair signed packages",
    "",
    " == Controls ==",
    " j / k   scroll dn/up",
    " Drag title bar: move",
...
impl TextViewerApp {
    ...
    pub fn welcome(x: i32, y: i32) -> Self {
        let lines = alloc::vec![
            ...
            String::from("  Terminal         commands, /bin/sh, pipes, and diagnostics"),
            ...
            String::from(
                "  sh, browser [url], help, sysreport write, devkit, services, jobs, fsck"
            ),
        ];
        Self::from_lines(
            x,
