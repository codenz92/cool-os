fn clean_modern_ascii_glyph(ch: char) -> Option<[u8; 8]> {
    let rows = match ch {
        ' ' => [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00],
        '!' => [0x08, 0x08, 0x08, 0x08, 0x08, 0x00, 0x08, 0x00],
        '"' => [0x14, 0x14, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00],
        '#' => [0x24, 0x24, 0x7E, 0x24, 0x7E, 0x24, 0x24, 0x00],
        '$' => [0x08, 0x3C, 0x0A, 0x3C, 0x50, 0x3C, 0x08, 0x00],
        '%' => [0x26, 0x26, 0x10, 0x08, 0x04, 0x32, 0x32, 0x00],
        '&' => [0x0C, 0x12, 0x12, 0x0C, 0x52, 0x22, 0x5C, 0x00],
        ...
        '6' => [0x3C, 0x02, 0x02, 0x3E, 0x42, 0x42, 0x3C, 0x00],
        '7' => [0x7E, 0x40, 0x20, 0x10, 0x08, 0x08, 0x08, 0x00],
        '8' => [0x3C, 0x42, 0x42, 0x3C, 0x42, 0x42, 0x3C, 0x00],
        '9' => [0x3C, 0x42, 0x42, 0x7C, 0x40, 0x40, 0x3C, 0x00],
        ...
        'Z' => [0x7E, 0x40, 0x20, 0x10, 0x08, 0x04, 0x7E, 0x00],
        '[' => [0x3C, 0x04, 0x04, 0x04, 0x04, 0x04, 0x3C, 0x00],
        '\\' => [0x02, 0x04, 0x04, 0x08, 0x10, 0x20, 0x40, 0x00],
        ']' => [0x3C, 0x20, 0x20, 0x20, 0x20, 0x20, 0x3C, 0x00],
        '^' => [0x08, 0x14, 0x22, 0x00, 0x00, 0x00, 0x00, 0x00],
        '_' => [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7E, 0x00],
        '`' => [0x04, 0x08, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00],
        'a' => [0x00, 0x00, 0x3C, 0x40, 0x7C, 0x42, 0x7C, 0x00],
        'b' => [0x02, 0x02, 0x3E, 0x42, 0x42, 0x42, 0x3E, 0x00],
        'c' => [0x00, 0x00, 0x3C, 0x42, 0x02, 0x42, 0x3C, 0x00],
        'd' => [0x40, 0x40, 0x7C, 0x42, 0x42, 0x42, 0x7C, 0x00],
        'e' => [0x00, 0x00, 0x3C, 0x42, 0x7E, 0x02, 0x3C, 0x00],
        'f' => [0x30, 0x08, 0x08, 0x3E, 0x08, 0x08, 0x08, 0x00],
        'g' => [0x00, 0x00, 0x7C, 0x42, 0x42, 0x7C, 0x40, 0x3C],
        'h' => [0x02, 0x02, 0x3E, 0x42, 0x42, 0x42, 0x42, 0x00],
        'i' => [0x08, 0x00, 0x0C, 0x08, 0x08, 0x08, 0x1C, 0x00],
        'j' => [0x20, 0x00, 0x30, 0x20, 0x20, 0x22, 0x22, 0x1C],
        'k' => [0x02, 0x02, 0x42, 0x22, 0x1E, 0x22, 0x42, 0x00],
        'l' => [0x0C, 0x08, 0x08, 0x08, 0x08, 0x08, 0x1C, 0x00],
        'm' => [0x00, 0x00, 0x36, 0x4A, 0x4A, 0x4A, 0x42, 0x00],
        'n' => [0x00, 0x00, 0x3E, 0x42, 0x42, 0x42, 0x42, 0x00],
        'o' => [0x00, 0x00, 0x3C, 0x42, 0x42, 0x42, 0x3C, 0x00],
        'p' => [0x00, 0x00, 0x3E, 0x42, 0x42, 0x3E, 0x02, 0x02],
        'q' => [0x00, 0x00, 0x7C, 0x42, 0x42, 0x7C, 0x40, 0x40],
        'r' => [0x00, 0x00, 0x3A, 0x46, 0x02, 0x02, 0x02, 0x00],
        's' => [0x00, 0x00, 0x7C, 0x02, 0x3C, 0x40, 0x3E, 0x00],
        't' => [0x08, 0x08, 0x3E, 0x08, 0x08, 0x48, 0x30, 0x00],
        'u' => [0x00, 0x00, 0x42, 0x42, 0x42, 0x42, 0x7C, 0x00],
        ...
        'y' => [0x00, 0x00, 0x42, 0x42, 0x42, 0x7C, 0x40, 0x3C],
        'z' => [0x00, 0x00, 0x7E, 0x20, 0x10, 0x08, 0x7E, 0x00],
