...
pub const KERNEL_ABI_VERSION: u64 = 9;
...
pub fn lines() -> Vec<String> {
    alloc::vec![
        ...
        String::from(
            "sdk: libcool v1 wraps startup, argv, process, files, pipes, mmap, shmem, net",
        ),
        ...
        String::from("syscalls: chdir/getcwd/stat/rename/open_write/spawn_fds_args/sync/time/poll"),
