...
pub const KERNEL_ABI_VERSION: u64 = 11;
...
pub fn lines() -> Vec<String> {
    alloc::vec![
        ...
        String::from(
            "sdk: libcool v1 wraps startup, argv, process, files, pipes, threads, futexes, mmap, shmem, net",
        ),
        ...
        String::from("syscalls: thread_spawn/futex_wait/futex_wake"),
        format!(
