...
fn shortcut_key_from_raw(code: KeyCode) -> Option<Key> {
    match code {
        ...
        KeyCode::Key5 => Some(Key::Character('5')),
        KeyCode::Key6 => Some(Key::Character('6')),
        KeyCode::Key7 => Some(Key::Character('7')),
        KeyCode::Key8 => Some(Key::Character('8')),
        KeyCode::Key9 => Some(Key::Character('9')),
        KeyCode::Key0 => Some(Key::Character('0')),
        KeyCode::Spacebar => Some(Key::Space),
        KeyCode::Tab => Some(Key::Tab),
        KeyCode::Escape => Some(Key::Escape),
        KeyCode::F4 => Some(Key::F4),
